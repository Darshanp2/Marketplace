...
const main = async () => { 
    ...
    let imagepath = "../../public/assets/watch.jpeg";
  try{
  ...
  try{
   ...
   try{
    ...
    try{
        var prod1 =await product.create('Watch','New watch',20,'Electronics',imagepath,'61b67afc46b47e6fba919bf9');
        console.log(prod1);
    }
    catch(e){
    console.log(e);
...
//   try{
//     await product.createUser('Meet', 'Jersey Heights','2345678901','meet@marketplace.com','Meet@23451');
//   }
//   catch(e)
//   {
//     console.log(e);
